...
{
    public class ColorTurningStrategyA : IInitiateColorTurningStrategy
    {
        private readonly IColorTurningLogic _colorTurningLogic;
        private readonly IDirectionChecker _directionChecker;
        public ColorTurningStrategyA(IDirectionChecker directionChecker, IColorTurningLogic colorTurningLogic)
        {
